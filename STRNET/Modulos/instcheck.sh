...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/pacstore/ANBIS/main/STRNET/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/pacstore/ANBIS/main/STRNET/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/pacstore/ANBIS/main/STRNET/Modulos/checkuser.py > /dev/null 2>&1
